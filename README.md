...
- Confirm your Ollama-compatible service is running
- Confirm the model name in main.py exists in your environment
- Retry with a smaller local model if needed

### Build verification fails repeatedly

- Open the project folder under projects/<slug>
- Read .agent_log and TODO.md for context
- Run the reported verification command manually
- Use /extend <slug> and request a targeted fix

### Terminal colors look odd on Windows

- Use a modern terminal (PowerShell 7, Windows Terminal)
- Ensure VT sequences are supported/enabled

## Why this project exists

Most coding assistants stop at suggestions. Kestrel is built to keep flying until there is working code on disk, with explicit stage outputs and verification loops so failures are visible and recoverable.
